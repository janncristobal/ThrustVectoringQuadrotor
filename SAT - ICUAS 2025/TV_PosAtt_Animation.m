...
x = states(10,1:intervals:end);
y = states(11,1:intervals:end);
z = states(12,1:intervals:end);
roll = states(4,1:intervals:end);
pitch = states(5,1:intervals:end); 
yaw = states(6,1:intervals:end);

beta = rotor_Params(5:8,1:intervals:end); %rotor Roll
eta = rotor_Params(9:12,1:intervals:end); %rotor Pitch

rotor_f1 = rotor_Forces(1:3,1:intervals:end); %forces in the x,y,z
rotor_f2 = rotor_Forces(4:6,1:intervals:end); %forces in the x,y,z
rotor_f3 = rotor_Forces(7:9,1:intervals:end); %forces in the x,y,z
rotor_f4 = rotor_Forces(10:12,1:intervals:end); %forces in the x,y,z
